...
def build_nn(cell, rnn_size, input_data, vocab_size):
    ...
    # Got some help with why my network wasn't converging from here https://discussions.udacity.com/t/passed-unit-tests-but-training-error-stuck-around-8-8/233306/9
